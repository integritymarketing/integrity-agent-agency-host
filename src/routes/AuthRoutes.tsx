...
const ContactSupportInvalidNPN = lazy(() => import("@/auth/pages/ContactSupportInvalidNPN"));
...
const RegistrationConfirmEmailPage = lazy(() => import("@/auth/pages/RegistrationConfirmEmailPage"));
const RegistrationCheckEmailPage = lazy(() => import("@/auth/pages/RegistrationCheckEmailPage"));
const RegistrationConfirmLinkExpiredPage = lazy(() => import("@/auth/pages/RegistrationConfirmLinkExpiredPage"));
const RegistrationCompletedPage = lazy(() => import("@/auth/pages/RegistrationCompletedPage"));
const ForgotPasswordSentPage = lazy(() => import("@/auth/pages/ForgotPasswordSentPage"));
const PasswordResetExpiredPage = lazy(() => import("@/auth/pages/PasswordLinkExpiredPage"));
const PasswordUpdatePage = lazy(() => import("@/auth/pages/PasswordUpdatedPage"));
...
const AuthRoutes: React.FC = () => (
  <Routes>
    ...
    <Route path="/contact-support-invalid-npn/:npnId" element={<ContactSupportInvalidNPN />} />
    ...
    <Route path="/confirm-link-expired" element={<RegistrationConfirmLinkExpiredPage />} />
    <Route path="/registration-complete" element={<RegistrationCompletedPage />} />
    <Route path="/forgot-password-sent" element={<ForgotPasswordSentPage />} />
    <Route path="/password-reset-expired" element={<PasswordResetExpiredPage />} />
